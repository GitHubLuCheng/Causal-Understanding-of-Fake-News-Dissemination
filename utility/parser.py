...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='Gossip',
                        help='Choose a dataset from {Gossip, Politifact}')
    ...
    parser.add_argument('--lr', type=float, default=1e-3, #1e-3 for BPRMF
                        help='Learning rate.')

    parser.add_argument('--model_type', nargs='?', default='jrl',
